...
public:
	...
	/// Obtiene el índice de la primera ocurrencia del elemento indicado dentro 
	///de la lista

		/// <param name="item">Elemento a verificar</param>
		/// <returns>El índice (base 0) de la primera ocurrencia si lo encontró, -1 
	...
	/// <summary>
	/// Obtiene el índice de la última ocurrencia del elemento indicado dentro de 
	///la lista
		/// </summary>
		/// <param name="item">Elemento a verificar</param>
/// <returns>El índice (base 0) de la última ocurrencia si lo encontró, -1 en 
